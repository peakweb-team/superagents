...
This keeps the builder lightweight, reviewable, and aligned with Superagents's goal of becoming an adaptive workflow operating layer rather than a giant setup wizard.
